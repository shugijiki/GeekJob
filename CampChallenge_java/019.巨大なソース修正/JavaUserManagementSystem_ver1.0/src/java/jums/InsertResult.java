...
//Table 'challenge_db.user_t' doesn't exist
/**
...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            //ユーザー情報に対応したJavaBeansオブジェクトに格納してい
            int a=Integer.parseInt((String)udb.getYear());
            int b=Integer.parseInt((String)udb.getMonth());
            int c=Integer.parseInt((String)udb.getDay());
